...
if (Image_Type == "Bio-format Image") {
	...
	Dialog.addChoice("Channel 1", items, "DAPI");
	Dialog.addChoice("Channel 2", items, "Fiber Borders");
	Dialog.addChoice("Channel 3", items, "MHCI");
	Dialog.addChoice("Channel 4", items, "MHCIIa");
	Dialog.addChoice("Channel 5", items, "MHCIIb");
	...
	items = newArray("Fiber Borders", "MHCI", "MHCIIa", "MHCIIb", "DAPI", "Satellite Cells", "*None*");
	Dialog.addChoice("Red", items, "Fiber Borders");
	Dialog.addChoice("Green", items, "MHCIIa");
	Dialog.addChoice("Blue", items, "DAPI");
	Dialog.addChoice("Gray", items, "*None*")
	Dialog.addChoice("Cyan", items, "*None*");
	Dialog.addChoice("Magenta", items, "MHCI");
	Dialog.addChoice("Yellow", items, "MHCIIb")
	Dialog.show();
}
